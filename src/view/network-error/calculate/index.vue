  ...
  methods: {
    handleSearch () {
      this.chartData = {
        ...
        itemData: [
          {
            data: [7.38, 7.73, 7.46, 3.95, 3.82, 3.7, 3.75, 7.85, 7.68, 7.45, 6.94, 6.7, 5.98, 6.25, null, null, null, null, null, null, null, null, null, null, null, null, null],
            name: '历史'
          },
          {
            data: [null, null, null, null, null, null, null, null, null, null, null, null, null, 6.25, 7.45, 4.57, 4.58, 4.33, 4.6, 4.42, 4.38, 3.95, 3.82, 3.7, 3.75, 3.71],
            name: '预测'
          }
        ]
      }
    ...
    setChartsOption (echartData) {
      ...
      let seriesData = !echartData ? [] : (echartData.itemData ? echartData.itemData.map(function (item) {
        return {
          ...
          lineStyle: {
            type: item.name === '预测' ? 'dashed' : 'solid'
          },
          name: item.name,
          data: item.data
        }
